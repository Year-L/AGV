...
class MultiNav():  
    def __init__(self):  
        ...
        # 停留时间设置为30秒  
        self.rest_time = rospy.get_param("~rest_time", 40)  
        ...
        #self.locations['point-1'] = Pose(Point(2.2, -4.6, 0.00), Quaternion(0.000, 0.000, 0.0, 1.0)) 
        #self.locations['point-2'] = Pose(Point(6.0, -4.7, 0.00), Quaternion(0.000, 0.000, 0.0, 1.0))
        #self.locations['point-3'] = Pose(Point(10.4, -4.75, 0.00), Quaternion(0.000, 0.000, 0.0, 1.0))
        #self.locations['point-4'] = Pose(Point(14.4, -4.8, 0.00), Quaternion(0.000, 0.000, 0.0, 1.0))
        self.locations['point-1'] = Pose(Point(2.4125, -3.7212, 0.00), Quaternion(0.000, 0.000, 0.689854, 0.723949)) 
        self.locations['point-2'] = Pose(Point(2.1008, -7.58045, 0.00), Quaternion(0.000, 0.000, -7.50106, 0.661317))
        self.locations['point-3'] = Pose(Point(6.02442, -3.51873, 0.00), Quaternion(0.000, 0.000, 0.685412, 0.728155))
        self.locations['point-4'] = Pose(Point(6.18844, -7.94154, 0.00), Quaternion(0.000, 0.000, -0.720904, 0.693035))
        self.locations['point-5'] = Pose(Point(0.266554, -5.5538, 0.00), Quaternion(0.000, 0.000, -0.0361129, 0.999348))
