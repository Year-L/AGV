...
echo_and_run cd "/home/bibibaba/bibibaba/src/rbx2/rbx2_tasks"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/bibibaba/bibibaba/src/rbx2/rbx2_tasks/setup.py" \
     \
    build --build-base "/home/bibibaba/bibibaba/build/rbx2/rbx2_tasks" \
    install \
    --root="${DESTDIR-/}" \
