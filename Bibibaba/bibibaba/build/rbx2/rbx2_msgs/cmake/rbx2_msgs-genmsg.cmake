...
get_filename_component(_filename "/home/bibibaba/bibibaba/src/rbx2/rbx2_msgs/srv/SetBatteryLevel.srv" NAME_WE)
add_custom_target(_rbx2_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rbx2_msgs" "/home/bibibaba/bibibaba/src/rbx2/rbx2_msgs/srv/SetBatteryLevel.srv" ""
)
...
_generate_srv_cpp(rbx2_msgs
  "/home/bibibaba/bibibaba/src/rbx2/rbx2_msgs/srv/SetBatteryLevel.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rbx2_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rbx2_msgs\")")
  # install generated code
  install(
