...
class TFSubscriptionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TFSubscriptionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TFSubscriptionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TFSubscriptionActionFeedback(null);
    ...
    data.feedback = TFSubscriptionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += TFSubscriptionFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TFSubscriptionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TFSubscriptionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TFSubscriptionFeedback()
    }
...
module.exports = TFSubscriptionActionFeedback;
