...
if("TRUE" STREQUAL "TRUE")
  set(rbx2_ar_tags_SOURCE_PREFIX /home/bibibaba/bibibaba/src/rbx2/rbx2_ar_tags)
  set(rbx2_ar_tags_DEVEL_PREFIX /home/bibibaba/bibibaba/devel)
  ...
  set(rbx2_ar_tags_INSTALL_PREFIX /home/bibibaba/bibibaba/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/rbx2_ar_tags " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/rbx2_ar_tags' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rbx2_ar_tags' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rbx2_ar_tags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bibibaba/bibibaba/src/rbx2/rbx2_ar_tags/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rbx2_ar_tags_NUM_DUMMY_TARGETS)
      set(rbx2_ar_tags_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rbx2_ar_tags::wrapped-linker-option${rbx2_ar_tags_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rbx2_ar_tags_NUM_DUMMY_TARGETS "${rbx2_ar_tags_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rbx2_ar_tags::wrapped-linker-option${rbx2_ar_tags_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rbx2_ar_tags_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rbx2_ar_tags_dep}_FOUND)
      find_package(${rbx2_ar_tags_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rbx2_ar_tags_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(rbx2_ar_tags_EXPORTED_TARGETS ${${rbx2_ar_tags_dep}_EXPORTED_TARGETS})
endforeach()
