...
struct RepublishTFsRequest_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _source_frames_type;
...
bool operator==(const ::tf2_web_republisher::RepublishTFsRequest_<ContainerAllocator1> & lhs, const ::tf2_web_republisher::RepublishTFsRequest_<ContainerAllocator2> & rhs)
{
...
struct Definition< ::tf2_web_republisher::RepublishTFsRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "## Notify the tf2_web_republisher that republishing of certain\n"
"## TFs is desired\n"
...
struct Printer< ::tf2_web_republisher::RepublishTFsRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::tf2_web_republisher::RepublishTFsRequest_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.source_frames.size(); ++i)
    {
      ...
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.source_frames[i]);
    }
