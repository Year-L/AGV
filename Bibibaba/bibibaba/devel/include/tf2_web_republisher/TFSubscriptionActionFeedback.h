...
bool operator==(const ::tf2_web_republisher::TFSubscriptionActionFeedback_<ContainerAllocator1> & lhs, const ::tf2_web_republisher::TFSubscriptionActionFeedback_<ContainerAllocator2> & rhs)
{
