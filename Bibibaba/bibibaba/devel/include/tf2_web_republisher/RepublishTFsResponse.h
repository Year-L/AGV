...
bool operator==(const ::tf2_web_republisher::RepublishTFsResponse_<ContainerAllocator1> & lhs, const ::tf2_web_republisher::RepublishTFsResponse_<ContainerAllocator2> & rhs)
{
