...
bool operator==(const ::tf2_web_republisher::TFSubscriptionAction_<ContainerAllocator1> & lhs, const ::tf2_web_republisher::TFSubscriptionAction_<ContainerAllocator2> & rhs)
{
